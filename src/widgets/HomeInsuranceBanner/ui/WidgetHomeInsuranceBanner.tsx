      ...
      <div className={styles.contacts__content}>
        <div className={styles.contacts__text}>
          <Typography
            ...
            bold={700}
          >
            Надёжное страхование вашего дома — просто и удобно
          </Typography>
          <Typography
            type={ETypographyType.h5}
            className={styles.contacts__text}
          >
            Мы&nbsp;предлагаем комплексное страхование домов, которое покрывает все основные риски.
            Наша задача&nbsp;&mdash; защитить ваше имущество и&nbsp;дать уверенность
            в&nbsp;завтрашнем дне.
          </Typography>
        </div>
      </div>
